          ...
          <AspectRatio ratio={4/3}>
            <div className="relative w-full h-full bg-gradient-to-br from-[hsl(215,85%,42%)] to-[hsl(215,85%,25%)]">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-4">
                ...
                <Link href="/schedule">
                  <Button size="default" className="bg-white/20 backdrop-blur-sm text-white font-bold ring-2 ring-white/70" data-testid="button-view-schedule-mobile">
          ...
          <AspectRatio ratio={16/9}>
            <div className="relative w-full h-full bg-gradient-to-br from-[hsl(215,85%,42%)] to-[hsl(215,85%,25%)]">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-4">
                ...
                <Link href="/schedule">
                  <Button size="lg" className="text-lg bg-white/20 backdrop-blur-sm text-white font-bold ring-2 ring-white/70" data-testid="button-view-schedule">
