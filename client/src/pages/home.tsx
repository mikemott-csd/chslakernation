      ...
      <header className="h-16 md:h-24 bg-gradient-to-r from-[hsl(215,85%,42%)] to-[hsl(215,85%,30%)] flex items-center justify-between px-3 md:px-8 shadow-md">
        ...
        <nav className="flex gap-1 md:gap-3 items-center">
          ...
          <Link href="/subscribe">
            ...
            <Button className="bg-green-600 text-white border-0 font-bold shadow-lg hidden md:flex" data-testid="button-get-notifications">
          ...
          <AspectRatio ratio={4/3}>
            <div className="relative w-full h-full bg-gradient-to-br from-[hsl(215,85%,42%)] to-[hsl(215,85%,25%)]">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-4">
                ...
                <Link href="/schedule">
                  <Button size="default" className="bg-white/20 backdrop-blur-sm text-white font-bold border border-white/70" data-testid="button-view-schedule-mobile">
          ...
          <AspectRatio ratio={16/9}>
            <div className="relative w-full h-full bg-gradient-to-br from-[hsl(215,85%,42%)] to-[hsl(215,85%,25%)]">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-4">
                ...
                <Link href="/schedule">
                  <Button size="lg" className="text-lg bg-white/20 backdrop-blur-sm text-white font-bold border border-white/70" data-testid="button-view-schedule">
        ...
        <section className="mt-12">
          <Card className="bg-gradient-to-r from-[hsl(215,85%,42%)] to-[hsl(215,85%,30%)] text-white border-0">
            <CardContent className="p-8 md:p-12 text-center">
              ...
              <Link href="/subscribe">
                <Button size="lg" className="bg-green-600 text-white border-0 font-bold shadow-lg" data-testid="button-subscribe-cta">
